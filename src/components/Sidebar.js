  ...
  return (
    <aside className="sidebar">
      ...
      <div className="field">
        ...
        <input type="number" value={dailyQueries} onChange={(e) => setDailyQueries(e.target.value)} />
      </div>
      <div className="field">
        <label>Daily Users:</label>
        <input type="number" value={dailyUsers} onChange={(e) => setDailyUsers(e.target.value)} />
      </div>
      <div className="field">
      ...
      <div className="field">
        ...
        <input type="number" value={datacenters} onChange={(e) => setDatacenters(e.target.value)} />
      </div>
    </aside>
  );
}
